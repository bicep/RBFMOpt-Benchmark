...
from utils.pygmo_utils import calculate_mean, reconstruct_hv_per_feval, plot_spline
...
pop_size = 24
seed = 33
problem = pg.problem(pg.problems.dtlz(7, dim=6, fdim=2))
...
plt.grid()
plt.savefig("/Users/rogerko/dev/Opossum/PygRbfMopt/graphics/Benchmark_Multi3.png")
plt.show()
